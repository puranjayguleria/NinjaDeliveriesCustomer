    ...
    return (
      <View style={styles.notLoggedInContainer}>
        ...
        <Button
          mode="contained"
          onPress={() => {
            console.log("Login button pressed from ProfileScreen");
        ...
        <Animated.View style={{ opacity: screenFade }}>
          ...
          >
            <View style={styles.heroTopRow}>
              ...
              <Text style={[styles.heroTitle, { color: "#111827" }]}>Profile</Text>
              <View style={{ width: 34 }} />
            </View>
          ...
          <View style={[styles.card, { backgroundColor: "#1E1E1E" }]}>
            ...
            <TileButton
              ...
              onPress={() => {
                vibrateTap();
                (navigation as any).navigate("TermsAndConditions", { viewOnly: true });
              }}
            />
          </View>
          ...
          <View style={[styles.card, { backgroundColor: "#1E1E1E" }]}>
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.optionSub, { marginLeft: 8 }]}>Permanently remove data</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color="#9CA3AF" />
            </TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  ...
  dangerIcon: {
    backgroundColor: "rgba(239,68,68,0.15)", // Slightly more opaque for dark mode
  },
  dangerText: {
    color: "#B91C1C",
  },
