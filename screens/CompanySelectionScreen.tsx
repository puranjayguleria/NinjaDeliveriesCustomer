...
export default function CompanySelectionScreen() {
  ...
  const { serviceTitle, categoryId, issues, selectedIssueIds, selectedIssues, companiesWithPackages, allCompanies } = route.params;
  ...
  const fetchServiceCompanies = async () => {
    try {
      ...
      console.log(`🏢 Found ${fetchedCompanies.length} companies with enhanced packages:`, 
