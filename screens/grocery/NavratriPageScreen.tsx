  ...
  const handleCardPress = async (title: string) => {
    ...
    switch (title) {
      case "Pooja Essentials":
        content = "Detailed guides for each of the nine days of Navratri, including mantras, offerings, and significance.";
        break;
      case "Dry Fruits":
        content = "Premium quality dry fruits and nuts for your festive needs.";
        break;
      case "Dairy":
        content = "Fresh milk, curd, and other dairy essentials for your daily rituals.";
        break;
      case "Fruits":
        content = "Fresh and seasonal fruits for offerings and healthy snacking.";
        break;
      case "Instant Food":
        content = "Quick and easy to prepare food items for your festive celebrations.";
        break;
    }
